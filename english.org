...
** Practice
*** New
**** +Si bien eshell puede parecer un shell, como Bash, debes verlo como un REPL con expresiones s sin paréntesis.
While eshell may look like a shell, like Bash, you should view it as a REPL with parenthesis-less s-expressions.

**** +En la semana veo el que acabas de publicar.
I'll watch the one you just published during the week.

**** +No todo funciona como me gustaría que funcionara
not everything works as I would like it to work

**** +Desde el cambio de nombre, ha sido simplificado para ofrecer/servir simplemente archivos
Since the name change, it's been stripped down to simply serve files

**** +haciéndome sentir un un poco de vergüenza y mucha alegría :-)
making me feeling a little bit of shame and a lot of joy :-)

**** +Lo bien que la descarga funciona en la práctica puede variar un poco/puede ser un poco variable. Un modo simple o un conjunto de algunos/unos pocos comandos normalmente está bien; algo de lujo podría no estar configurado para deshacerse por completo.
...
**** +, y tiene un coste/ y viene con un costo:
, and it does come at a cost:

**** +Para ejecutar los ganchos predeterminados, se me ocurrió esto, que es realmente estúpido o realmente genial.
To run the default hooks, I came up with this, which is either really stupid or really cool.

**** +No estoy aquí para responder preguntas personales que tengas conmigo.
I'm not here to answer personal question that you have with me

**** +Si compila Emacs con esta bandera, como he hecho y sigo haciendo,
If you do compile Emacs with this flag, as I have and still do


**** , merece más que la pena a largo plazo. Cualquier herramienta que utilices a menudo merece el tiempo dedicado a aprender a dominarla.
, it is more than worthwhile in the long run. Any tool you use often deserves the time spent learning to master it

**** En el segundo en que me tocara, descubriría lo mala que era su idea/su idea fue
The second it touched me, he would find out how bad his idea was

**** Les dije a todos que les mostraría los números de fin de mes. El canal está creciendo, sin duda.
Told everyone I would show the end of the months numbers. The channel is growing, no doubt.

**** Cuando esté presente, el modo empresa se configurará automáticamente y simplemente funcionará.
When present, company-mode will be auto-configured and it will just work.

**** El soporte de SQLite, de una forma u otra, existe desde hace algún tiempo.
SQLite support, in one form or another, has been around for a while.

**** en cuanto a los invitados no quiero que se sientan incómodos
as far as the guests I don't wnat them to feel uncomfortable

**** Cambio mecánico que es poco probable que afecte al uso diario si usas cabezeras.
Mechanical change that is unlikely to affect day-to-day use if you use outline.

**** moverse mediante la expresión s, tomará un poco de tiempo acostumbrarse,
Moving by s-expression will take a bit of getting used to,

**** haciendolo (equis cosa) menos conocido de lo que debería ser;
making it less known than it should be;

**** ¿Qué sería de Emacs sin Emacs Lisp?
what would Emacs be without Emacs Lisp?

**** Las macros de teclado se malinterpretan y pueden hacer mucho más de lo que la mayoría de la gente cree que pueden hacer.
Keyboard macros are misunderstood, and they can do an awful lot more than most people think they can do.

**** Parece útil. Tendría que usarlo por un tiempo para determinar qué tan confiable es.
Seems useful. I’d have to use it for a while to determine how reliable it is.

**** Es fantasticamente avanzado y vale la pena aprenderlo si haces muchas matemáticas.
It’s fantastically advanced, and well worth learning if you do a lot of mathematics.

**** También puede personalizar 'major-mode-remap-alist' para activar automáticamente algunos modos basados en tree-sitter para los mismos archivos para los que se activaría un modo "incorporado".
You can also customize 'major-mode-remap-alist' to automatically turn on some tree-sitter based modes for the same files for which a "built-in" mode would be turned on.
