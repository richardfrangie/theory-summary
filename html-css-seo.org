...
***** Brief
The display type of an element defines the outer display type; this dictates *how the box displays alongside other elements in the same formatting context*. (Define como se comporta un elemento con respecto a los elementos a su alrededor (fuera de este), como fluye en la página)
...
***** Grid/Flex and absolutely positioned elements
*ManzDev*
