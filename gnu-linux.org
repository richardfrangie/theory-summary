...
*** VIA
**** Brief
VIA is essential for custom keyboard enthusiasts, offering unparalleled customization and ease of use. Its intuitive interface allows for effortless remapping of keys, creation of complex macros, and management of multiple layers, empowering users to tailor their keyboard experience to perfection.
...
***** TG(n)
The TG(n) function stands for "*toggle*," which facilitates a *permanent switch* to Layer n without reverting automatically to Layer 0. This function allows toggling between two layers, but it does not support switching among multiple layers.
