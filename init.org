...
#+begin_src emacs-lisp
  ...
  (keymap-set global-map "M-J" switch-resize-windows-repeat-map)
  ...
  (use-package treesit
    ...
    (use-package combobulate
      ...
      (defvar-keymap combobulate-navigate-repeat-map
        ...
        "m" #'combobulate-navigate-previous
        "w" #'combobulate-navigate-next
        "d" #'combobulate-navigate-beginning-of-defun
        "b" #'combobulate-navigate-end-of-defun)
