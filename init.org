...
#+begin_src emacs-lisp
  ...
  (use-package consult
    ...
    (defvar-keymap consult-search-map
      ...
      "u" #'consult-keep-lines
      "e" #'consult-focus-lines
      "p" #'consult-yasnippet
      "." #'consult-kmacro
      "}" #'consult-register)
...
#+begin_src emacs-lisp
  ...
  (defvar-keymap extend-selection-repeat-map
    :doc "Keymap for repeating `xah-extend-selection' command."
    :repeat t
    ")" #'rf/expand-region)
...
#+begin_src emacs-lisp
  ...
  (defvar-keymap goto-last-repeat-map
    :doc "Keymap to repeat goto-last-change command."
    :repeat t
    "d" #'goto-last-change)
...
#+begin_src emacs-lisp
  ...
  (dolist (binds
           '(
             ;; ("M-~" . )
             ("M-%" . delete-frame)
             ("M-7" . delete-other-windows)
             ("M-5" . query-replace-regexp)
             ("M-3" . replace-regexp)
             ("M-1" . split-window-below)
             ;; ("M-9" . )
             ;; ("M-0" . )
             ;; ("M-2" . )
             ;; ("M-4" . )
...
#+begin_src emacs-lisp
  ...
  (dolist (binds
           '(
             ...
             ("C-M-e" . rf/swap-org-header-with-text)
             ))
    (keymap-global-set (car binds) (cdr binds)))
...
#+begin_src emacs-lisp
  ...
  (use-package js
    ...
    :bind (:map js-mode-map
                ("<f6> e" . rf/js-save-eval-print)
                ("<f6> u" . rf/js-console-log-wrap))
    :config
