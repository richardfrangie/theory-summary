...
[ /-i/ ignore-case /-v/ invert, print only those lines that don't match /-E/ extended-regexp (EREs) /-G/ basic-regexp (BREs) /-q/ quiet /-c/ count matching lines /-l/ name of each file /-L/ name file that don't match /-n/ number line /-h/ suppress the output of filenames for multi-file search ]
...
*** apt update
Is used to download package information from all configured sources.
